...
*/
class CAsproCatalogSmartFilter extends CBitrixComponent
{
	var $IBLOCK_ID = 0;
	var $SKU_IBLOCK_ID = 0;
	...
	public function onPrepareComponentParams($arParams)
	{
		...
		if ($arParams["SECTION_ID"] <= 0 && CModule::IncludeModule('iblock'))
		{
	...
	public function executeComponent()
	{
		...
		if (self::$catalogIncluded === null)
			self::$catalogIncluded = CModule::IncludeModule('catalog');
		...
		$this->facet = new \Bitrix\Iblock\PropertyIndex\Facetroot($this->IBLOCK_ID);
