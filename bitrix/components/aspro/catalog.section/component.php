...
if((IntVal($arParams["IBLOCK_ID1"]) > 0)||(IntVal($arParams["IBLOCK_ID2"]) > 0)||(IntVal($arParams["IBLOCK_ID3"]) > 0)||(IntVal($arParams["IBLOCK_ID4"]) > 0))
{
	...
	if (IntVal($arParams["IBLOCK_ID"]) > 0) $arIblocksFilter[] = $arParams["IBLOCK_ID1"];
	if (IntVal($arParams["IBLOCK_ID_EXT_1"]) > 0) $arIblocksFilter[] = $arParams["IBLOCK_ID_EXT_1"];
	if (IntVal($arParams["IBLOCK_ID_EXT_2"]) > 0) $arIblocksFilter[] = $arParams["IBLOCK_ID_EXT_2"];
	if (IntVal($arParams["IBLOCK_ID_EXT_3"]) > 0) $arIblocksFilter[] = $arParams["IBLOCK_ID_EXT_3"];
}
