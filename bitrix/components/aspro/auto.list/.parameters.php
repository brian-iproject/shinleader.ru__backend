...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"TYPE_FILTER" => Array(
			...
			"TYPE" => "LIST",
			"VALUES" => array("tires" => GetMessage("AUTO_LIST_PARAMS_TYPE_FILTER_TIRES"), "wheels" => GetMessage("AUTO_LIST_PARAMS_TYPE_FILTER_WHEELS")),
			"DEFAULT" => "tires",
			"REFRESH" => "Y",
		),
		"INSTANT_RELOAD" => Array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("AUTO_LIST_PARAMS_INSTANT_RELOAD"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
	),
