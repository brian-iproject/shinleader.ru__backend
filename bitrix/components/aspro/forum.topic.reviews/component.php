...
if (isset($_REQUEST["ELEMENT_ID"])) {$arParams["ELEMENT_ID"] = $_REQUEST["ELEMENT_ID"];}
else {$arParams["ELEMENT_ID"] = IntVal($arParams["ELEMENT_ID"]);}
...
/***************** URL *********************************************/
	$URL_NAME_DEFAULT = array(
			...
			"detail" => "PAGE_NAME=detail&SECTION_ID=#ELEMENT_ID#");
...
/********************************************************************
				Default values
 ********************************************************************/
$arResult["FORUM_TOPIC_ID"] = intval($arResult["ELEMENT"]["UF_FORUM_TOPIC_ID"]);
...
$arResult["ELEMENT"] = array(
	...
	"PRODUCT_PROPS" => array());
if (is_set($arResult["ELEMENT_REAL"], "UF_FORUM_TOPIC_ID"))
{
	$arResult["ELEMENT"]["PRODUCT_PROPS"]["FORUM_TOPIC_ID"] = array("VALUE" => $arResult["ELEMENT_REAL"]["UF_FORUM_TOPIC_ID"]);
	$arResult["ELEMENT"]["PRODUCT_PROPS"]["~FORUM_TOPIC_ID"] = array("VALUE" => $arResult["ELEMENT_REAL"]["~UF_FORUM_TOPIC_ID"]);
}
if (is_set($arResult["ELEMENT_REAL"], "UF_FORUM_MESSAGE_CNT"))
{
	$arResult["ELEMENT"]["PRODUCT_PROPS"]["FORUM_MESSAGE_CNT"] = array("VALUE" => $arResult["ELEMENT_REAL"]["UF_FORUM_MESSAGE_CNT"]);
	$arResult["ELEMENT"]["PRODUCT_PROPS"]["~FORUM_MESSAGE_CNT"] = array("VALUE" => $arResult["ELEMENT_REAL"]["~UF_FORUM_MESSAGE_CNT"]);
}
/* For custom template */
// *****************************************************************************************
