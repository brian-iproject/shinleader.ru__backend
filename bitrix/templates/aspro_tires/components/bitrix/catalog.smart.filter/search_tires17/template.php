...
<?$arResult["JS_FILTER_PARAMS"]['SEF_SET_FILTER_URL'] = $arResult["JS_FILTER_PARAMS"]['SEF_DEL_FILTER_URL'] = false;?>
	...
	<script>
		...
		{
			smartFilterTires.click($("#filter_form input").first()[0])
			return false;
...
<script type="text/javascript">
	var smartFilterTires = new JCSmartFilter('<?echo CUtil::JSEscape(str_replace('catalog', 'search', $arResult["FORM_ACTION"]))?>', 'horizontal', <?=CUtil::PhpToJSObject($arResult["JS_FILTER_PARAMS"])?>);
</script>