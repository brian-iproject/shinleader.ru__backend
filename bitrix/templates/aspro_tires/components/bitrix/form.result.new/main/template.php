...
$(document).ready(function()
{
	...
	{
		$("form[name=<?=$arResult["arForm"]["VARNAME"];?>]").validate({onfocusout: false,
		messages:{
				licenses_popup: {
					required : BX.message('JS_REQUIRED_LICENSES')
				}
...
<?}else{?>
	...
	<div class="form-wr">
		...
		<div class="but_wr">
			<!--noindex-->
				<button type="submit" name="web_form_submit" class="button1" value="submit"><?=GetMessage("FORM_SEND")?></button>
			<!--/noindex-->
		</div>
		</div>
