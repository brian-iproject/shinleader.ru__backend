<?if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?><?$APPLICATION->SetTitle("Смена пароля");?>
...
$(document).ready(function(){
    ...
    <div class="form-block">
        <form method="post" action="/auth/change-password/" name="bform" class="bf">
            ...
            <div class="but-r">
				<button class="button1" type="submit" name="change_pwd" value="<?=GetMessage("AUTH_CHANGE")?>"><span><?=GetMessage("CHANGE_PASSWORD")?></span></button>				
			</div>            
    	</form>
