...
if (!funcDefined("oneClickBuy"))
{
	var oneClickBuy = function (elementID, iblockID)
	{
		...
		$('.'+name+'_frame').jqm({trigger: '.'+name+'_trigger', onHide: function(hash) { onHidejqm(name,hash); }, onLoad: function( hash ){ onLoadjqm( "one_click_buy", hash ); }, ajax: arTiresOptions["TIRES_SITE_DIR"]+'ajax/one_click_buy.php?ELEMENT_ID='+elementID+'&IBLOCK_ID='+iblockID+'&ELEMENT_QUANTITY='+elementQuantity});
		$('.'+name+'_trigger').click();
	}
}
...
if (!funcDefined("oneClickBuyBasket"))
{
	var oneClickBuyBasket = function ()
	{
		...
		$('body').append('<div class="'+name+'_frame popup"></div>');
		$('body').append('<div class="'+name+'_trigger"></div>');
		$('.'+name+'_frame').jqm({trigger: '.'+name+'_trigger', onHide: function(hash) { onHidejqm(name,hash); }, onLoad: function( hash ){ onLoadjqm( "one_click_buy_basket", hash ); }, ajax: arTiresOptions["TIRES_SITE_DIR"]+'ajax/one_click_buy_basket.php'});
		$('.'+name+'_trigger').click();
	}
}
