<?
	...
	$MESS ['SOA_TEMPL_ORDER_SUC1'] = "Отследить состояние заказа можно в вашем <a href=\"#LINK#\">личном кабинете</a>.";
	...
	$MESS["SALE_ORDER_NUMBER"] = "Номер заказа";
	$MESS["SALE_ORDER_DATE"] = "Дата оформления";
	$MESS["SALE_ORDER_DESCRIPTION"] = "На почтовый ящик <a href='mailto:#CLIENT_EMAIL#'>#CLIENT_EMAIL#</a><br /> отправления копия заказа";
	$MESS["ORDER_ISSUED"] = "Заказ оформлен";
	$MESS["ORDER_ISSUED_DESCRIPTION"] = "Заказ успешно оформлен и будет обработан в ближайшее время";
	$MESS["ORDER_SUCCESS_INLUDE"] = "Сообщение об успешном заказе";
?>