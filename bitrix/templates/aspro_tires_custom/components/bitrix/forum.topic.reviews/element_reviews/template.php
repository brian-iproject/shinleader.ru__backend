...
<div class="reviews-collapse reviews-minimized" style='position:relative; float:none;'>
	<a class="button25 reviews-collapse-link" onclick="fToggleCommentsForm(this)" href="javascript:void(0);"><?=$arParams['MINIMIZED_EXPAND_TEXT']?></a>
</div>
<? } ?>
...
?>
		<div class="reviews-reply-buttons">
			<input name="send_button" type="submit" class="button1" value="<?=GetMessage("OPINIONS_SEND")?>" tabindex="<?=$tabIndex++;?>" <?
				?>onclick="this.form.preview_comment.value = 'N';" />
			<input name="view_button" type="submit" class="button2" value="<?=GetMessage("OPINIONS_PREVIEW")?>" tabindex="<?=$tabIndex++;?>" <?
