					...
					<tr>
						<td class="thumb-cell not_avail">
							...
							<?if( $arItem["DETAIL_PICTURE"] != "" ){?>
								<a class="thumb"><img src="<?=$arItem["DETAIL_PICTURE"]["src"]?>" alt="<?=$arItem["NAME"]?>" title="<?=$arItem["NAME"]?>" /></a>
							<?}else{?>
								<a class="thumb"><img src="<?=SITE_TEMPLATE_PATH?>/images/noimage_small.png" alt="<?=$arItem["NAME"]?>" title="<?=$arItem["NAME"]?>" width="80" height="80" /></a>
							<?}?>	
						</td>
