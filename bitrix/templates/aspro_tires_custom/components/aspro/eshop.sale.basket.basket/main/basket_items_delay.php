						...
						<?if(in_array("NAME", $arParams["COLUMNS_LIST"])):?>
							<td class="name-cell">
								...
								<?if (in_array("DELAY", $arParams["COLUMNS_LIST"])){?>
									<a class="button25 set_aside" href="<?=str_replace("#ID#", $arItem["ID"], $arUrlTempl["add"])?>">
										<span class="full-text"><?=GetMessage("SALE_ADD_CART")?></span>
										<span class="short-text"><?=GetMessage("SALE_ADD_CART_2")?></span>
									</a>
								<?}?>
